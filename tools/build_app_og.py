...
""",
        ...
        "sub": "81 complete classics, read aloud over rain or firelight. Nightshelf&nbsp;Pro adds calm new stories written by AI.",
    },
    "mythwright": {
        "art": "app-icon.png",
        "css": """
...
""",
  ...
  .sub { font-family: 'Nunito', ui-rounded, sans-serif; color: #4A5E64;
         ...
         max-width: 440px; }
  /* Match the page's transparent companion portraits at their natural aspect ratio. */
  .art { width: 506px; height: auto; }
""",
...
""",
        # The page eyebrow, shortened. The iPhone app is not on sale (ASC 1.0
        # PREPARE_FOR_SUBMISSION on 2026-09-13), so the card claims only the browser
        # game, playable at /gemburrow/play/ (200) since before 2026-08-21. 41 chars,
        # the length measured against the nowrap above.
        "kicker": "Gem-digging puzzle \u00b7 play in your browser",
